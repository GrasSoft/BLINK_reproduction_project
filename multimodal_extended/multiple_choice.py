...
def build_prompt(question, options, prediction):
    """
    Builds the prompt for the model to match an answer with several options of a single-choice question.

    If the model is unable to find a match, it will output (Z).
...
def match_multiple_choice(
    question: str, options: str, prediction: str, model_name: str
):
    prompt = build_prompt(question, options, prediction)
